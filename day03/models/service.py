...
class Service(object):
    ...
    def fare_ordinal(this) -> object:
        this.train['FareBand'] = pd.qcut(this.train['Fare'], 4, labels={1, 2, 3, 4}) # FareBand as new feature
    ...
    def title_nominal(this) -> object:
        combine = [this.train, this.test]    # Title as new feature
    ...
    def age_ordinal(this) -> object:
        ...
        bins = [-1, 0, 5, 12, 18, 24, 36, 60, np.inf]
